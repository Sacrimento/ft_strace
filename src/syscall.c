...
t_syscall_info get_syscall_info(int id)
{
    static const t_syscall_info  syscalls_infos[] =
    {
        ...
        {"fork", 0, {}, LONG},
        {"vfork", 0, {}, LONG},
        {"execve", 3, {FILENAME, STRING_ARRAY, STRING_ARRAY}, LONG},
        {"exit", 1, {INT}, LONG},
        ...
        {"chmod", 2, {FILENAME, ADDR}, LONG},
        {"fchmod", 2, {UINT, ADDR}, LONG},
        {"chown", 3, {FILENAME, ADDR, ADDR}, LONG},
        {"fchown", 3, {UINT, ADDR, ADDR}, LONG},
        {"lchown", 3, {FILENAME, ADDR, ADDR}, LONG},
        {"umask", 1, {INT}, LONG},
        ...
        {"utime", 2, {FILENAME, ADDR}, LONG},
        {"mknod", 3, {FILENAME, ADDR, ADDR}, LONG},
        {"uselib", 1, {ADDR}, LONG},
        ...
        {"openat", 4, {INT, FILENAME, INT, INT}, LONG},
        {"mkdirat", 3, {INT, STRING, INT}, LONG},
        {"mknodat", 4, {INT, FILENAME, INT, ADDR}, LONG},
        {"fchownat", 5, {INT, FILENAME, ADDR, ADDR, INT}, LONG},
        {"futimesat", 3, {INT, FILENAME, ADDR}, LONG},
        {"newfstatat", 4, {INT, FILENAME, ADDR, INT}, LONG},
        ...
        {"fchmodat", 3, {INT, FILENAME, ADDR}, LONG},
        {"faccessat", 3, {INT, FILENAME, INT}, LONG},
        ...
        {"utimensat", 4, {INT, FILENAME, ADDR, INT}, LONG},
        ...
        {"_execveat", 5, {INT, FILENAME, ADDR, ADDR, INT}, LONG},
        {"faultfd", 1, {INT}, LONG},
